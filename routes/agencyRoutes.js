...
router.post(
    ...
    [
        ...
        check("representativeName", "Representative name length should be 1 to 30 characters")
            .trim()
            .isLength({ min: 1, max: 30 }),
        check("representativePhNo", "Representative number should contains 10 digits")
            .trim()
            .isInt()
            .isLength({ min: 10, max: 10 }),
        check("representativeEmail", "Representative email length should be 3 to 30 characters")
            .trim()
            .isEmail()
            .isLength({ max: 30 }),
        check("representativeDesignation", "Representative designation length should be 0 to 30 characters")
            .trim()
            .isLength({ max: 30 }),
    ],
    agencyRegister
